...
<body>
    <div class="wrapper">
      <header class="shapka">
        ...
        <a href="kadrovie.php">Кадровые</a>
...
<div class="products">
   <h1 class="heading">Аудит услуги</h1>
...
<div id="productModal" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="productModalLabel">Описание услуги</h5>
   ...
   <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `products_audit`") or die('query failed');
